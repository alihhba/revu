...
const ProjectCartV1 = ({ item, type = "line" }: props) => {
  ...
  return (
    ...
    >
      <CartWrapper
        className={cn(
          " px-p-16 relative rounded-[6px] w-full",
        ...
        >
          ...
          >
            <div
              className={cn(
                "max-md:hidden",
                type === "grid" ? "absolute start-p-16 top-p-16 " : ""
              )}
            >
              <CustomCheck
                onchange={() => {
            ...
            <div className="flex flex-col gap-p-9">
              ...
              {/* progress bar */}
              <div className={cn(type === "grid" ? "hidden" : "md:hidden")}>
                <ProgressBar all={item.tasksNum} done={item.doneNum} />
              </div>

              <div
                className={cn(
                  type === "grid" ? "flex  items-center gap-p-10 md:hidden " : "hidden"
                )}
              >
                <Badge
          ...
          {type !== "grid" ? (
            <div className="flex items-center gap-p-12">
              ...
              <div className="max-md:hidden">
                <Badge icon="/icons/comment.svg" title={item.commentsNum} />
              </div>

              <div className="max-md:hidden">
                <Badge icon="/icons/tag.svg" title={item.tagsNum} />
              </div>
